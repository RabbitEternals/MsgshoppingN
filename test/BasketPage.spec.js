...
describe("Shopping Page", () => {
    ...
    describe("Routing", () => {
        ...
        //TODO fix test
        it("displays shopping page after clicking to link", async () => {
            await setup();
            const link = await screen.findByText("Shopping Page");
            await userEvent.click(link);
            const basketPage = await screen.findByTestId("shopping-page");
